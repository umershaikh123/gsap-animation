...
export default function ScrollParallax() {
  ...
  return (
    <section ref={container} id="parallax" className="parallax-section relative min-h-[200vh] overflow-hidden">
      {/* Background layers */}
      ...
      <div className="parallax-front relative z-20 container mx-auto px-6 py-32">
        ...
        <div className="grid md:grid-cols-3 gap-8 mt-32">
          <div className="parallax-card bg-gray-800/80 backdrop-blur-md p-8 rounded-2xl shadow-2xl" data-speed="1.5">
            ...
            <p className="text-gray-300">Moves slowly, creating depth and dimension in your scroll experience.</p>
          </div>
          
          <div className="parallax-card bg-gray-800/80 backdrop-blur-md p-8 rounded-2xl shadow-2xl" data-speed="2">
            ...
            <p className="text-gray-300">Medium speed parallax effect for engaging visual storytelling.</p>
          </div>
          
          <div className="parallax-card bg-gray-800/80 backdrop-blur-md p-8 rounded-2xl shadow-2xl" data-speed="2.5">
            ...
            <p className="text-gray-300">Fastest moving layer, creating dynamic scroll interactions.</p>
          </div>
        </div>
